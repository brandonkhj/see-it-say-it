                ...
                >
                    ...
                    <div class="text-sm">
                        ...
                        >
                            @switch($value)
                                @case('near_miss')
                                    <img class="inline mr-1" src="{{ asset('assets/near-miss.png') }}" />
                                    @break
                                @case('property_damage')
                                    <img class="inline mr-1" src="{{ asset('assets/property-damage.png') }}" />
                                    @break
                                @case('unsafe_act')
                                    <img class="inline mr-1" src="{{ asset('assets/unsafe-act.png') }}" />
                                    @break
                                @case('unsafe_condition')
                                    <img class="inline mr-1" src="{{ asset('assets/unsafe-condition.png') }}" />
                                    @break
                                @default
                            @endswitch
                            {{ $label }}
